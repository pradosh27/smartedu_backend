...
const getSclassHOD = async (req, res) => {
    try {
        let HOD = await HOD.find({ sclassName: req.params.id })
        if (HOD.length > 0) {
...
const deleteSclass = async (req, res) => {
    try {
        ...
        const deletedHOD = await HOD.deleteMany({ sclassName: req.params.id });
...
const deleteSclasses = async (req, res) => {
    try {
        ...
        const deletedHOD = await HOD.deleteMany({ school: req.params.id });
...
module.exports = { sclassCreate, sclassList, deleteSclass, deleteSclasses, getSclassDetail, getSclassHOD };