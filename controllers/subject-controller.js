...
const deleteSubject = async (req, res) => {
    try {
        ...
        // Remove the objects containing the deleted subject from HOD' examResult array
        await HOD.updateMany(
            {},
            { $pull: { examResult: { subName: deletedSubject._id } } }
        );

        // Remove the objects containing the deleted subject from HOD' attendance array
        await HOD.updateMany(
            {},
...
const deleteSubjects = async (req, res) => {
    try {
        ...
        // Set examResult and attendance to null in all HOD
        await HOD.updateMany(
            {},
